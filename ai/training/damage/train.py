...
Usage:
    ...
    python -m training.damage.train
...
DATA_DIR    = BASE_DIR / "data" / "damage_assessment" / "train"
...
# Maps the output class name to an estimated damage percentage range midpoint
DAMAGE_PCT_MAP = {
    "non_damaged": 0.0,
    "damaged":     0.60,    # conservative midpoint; could be further split
}
